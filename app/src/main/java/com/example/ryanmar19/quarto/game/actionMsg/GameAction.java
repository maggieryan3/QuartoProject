package com.example.ryanmar19.quarto.game.actionMsg;
...
/**
 * An action for a generic com.example.ryanmar19.quarto.game.  A com.example.ryanmar19.quarto.game action is something that a player
 * tells the com.example.ryanmar19.quarto.game that it wants to do (e.g., put an 'X' on the top-left
 * tic-tac-toe square).  The com.example.ryanmar19.quarto.game will then decide whether the player is
 ...
 * actions that are relevant to the particular com.example.ryanmar19.quarto.game.  A GameAction contains
 * the player as part of its state; this way the com.example.ryanmar19.quarto.game always knows what
